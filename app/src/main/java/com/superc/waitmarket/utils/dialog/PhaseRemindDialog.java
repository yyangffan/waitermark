...
public class PhaseRemindDialog extends AlertDialog {
    private View mView;
    ...
    public PhaseRemindDialog(Context context, Builder builder, Display mDis) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(mContext).inflate(R.layout.phase_dialog_remind, null);
        initView();
    ...
    private void initView() {
        ...
        mtv_left.setTextColor(left_color == 0 ? mContext.getResources().getColor(R.color.txt_week) : mContext.getResources().getColor(left_color));
    ...
    public static class Builder {
        ...
        public PhaseRemindDialog build(Display mDis) {
            return new PhaseRemindDialog(mContext, this,mDis);
        }
