package com.superc.waitmarket.utils.picselector;
...
public class GridImageAdapter {
      /*  extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    *//**
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            ll_sel = (LinearLayout) view.findViewById(R.id.edtjichu_linear);
    ...
    *//**
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.ll_sel.setVisibility(View.VISIBLE);
            viewHolder.ll_sel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mOnAddPicClickListener.onAddPicClick();
                }
            });
          *//*  viewHolder.mImg.setImageResource(R.drawable.icon_tianjia);
            ...
            viewHolder.ll_sel.setVisibility(View.GONE);
