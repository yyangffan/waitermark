...
public class InputDialog extends AlertDialog {
    ...
    private InputDialog mPhaseRemindDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(mContext).inflate(R.layout.dialog_input, null);
        initView();
    ...
    public void showKeyboard() {
        if(mtv_content!=null){
            //设置可获得焦点
            mtv_content.setFocusable(true);
            mtv_content.setFocusableInTouchMode(true);
            //请求获得焦点
            mtv_content.requestFocus();
            //调用系统输入法
            InputMethodManager inputManager = (InputMethodManager) mtv_content
                    .getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
            inputManager.showSoftInput(mtv_content, 0);
        }
    }
...
//        setCon(mtv_content, content);
    ...
    public static class Builder {
        ...
        public InputDialog build() {
            return new InputDialog(mContext, this);
        }
