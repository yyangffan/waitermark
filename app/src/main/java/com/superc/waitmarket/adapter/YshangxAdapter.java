...
public class YshangxAdapter extends RecyclerView.Adapter<YshangxAdapter.ViewHolder> {
    ...
    public YshangxAdapter(Context context, List<String> stringList) {
        mContext = context;
        mLists = stringList;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_yshangx, parent, false);
...
//        String shoplogo = bean.getShopLogo();
        ...
        vh.mItemLeftState.setText("已上线");
        vh.mItemMagapbTitle.setText("鱼酷(万达店)");
        vh.mItemMagapbPosi.setText("美食·火锅" + position);
        vh.mItemMagapbTime.setText("近5日：共交易5笔，合计123456元" + position);
        vh.mItemMagapbPosiposi.setText("地址地址地址地址地址地址地址地址地址地址");
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.item_magapb_posiposi)
        TextView mItemMagapbPosiposi;
