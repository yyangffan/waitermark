...
public class ManaXeAdapter extends RecyclerView.Adapter<ManaXeAdapter.ViewHolder> {
    private Context mContext;
    private List<WeipaiBean.DataBean.ListBean> mLists;
    private LayoutInflater mInflater;
    private OnItemClickListener mOnItemClickListener;

    public ManaXeAdapter(Context context, List<WeipaiBean.DataBean.ListBean> stringList) {
        mContext = context;
        mLists = stringList;
    ...
    public void onBindViewHolder(final ViewHolder vh, final int position) {
        ...
        final WeipaiBean.DataBean.ListBean bean = mLists.get(position);
