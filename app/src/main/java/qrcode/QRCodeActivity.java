...
import static qrcode.Constants.PIC;
...
public class QRCodeActivity extends AppCompatActivity {
    ...
    protected void initViews() {
        ...
        if(intent!=null){
            ...
            String scannerTipText = intent.getStringExtra("scannerTipText");
            mTextView.setText(TextUtils.isEmpty(title)?"二维码":title);
            if(!TextUtils.isEmpty(scannerTipText)){
                mZxingViewFinderView.setScannerTipText(scannerTipText);
            }
        }
...
//                Toast.makeText(QRCodeActivity.this, "onTorchOff", Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.qrcode_imgv_back).setOnClickListener(new View.OnClickListener() {
            @Override
